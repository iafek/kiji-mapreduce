 ...
 */
@ApiAudience.Private
public final class CDH54KijiMRBridgeFactory extends KijiMRPlatformBridgeFactory {
  ...
  public int getPriority(Map<String, String> runtimeHints) {
    ...
    } else if (hadoopVer.matches("2\\..*") && hbaseVer.matches("1\\.0[0]\\..*")) {
      // This bridge may work for Hadoop 2 and HBase 1.0.0.
